...
outliers=c("7648_dc","7675_dc","7609_dc")
...
# cor7 spc1234int -------------
modVars<-c("GT","Time","seqPC1","seqPC2","seqPC3","seqPC4","GT*Time")
corname<-"SeqPC1234int"
dat.cor[[corname]]<-correct()

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr7.pdf")
mdsCompPlot(mds.list = mdslist[c("pre","SeqPC1234",corname)],fname = "MDS_Comp7.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC1234int_all.pdf")
...
# cor8 spc1234int2 -------------
modVars<-c("GT","Time","GT*Time","seqPC1","seqPC2","seqPC3","seqPC4")
corname<-"SeqPC1234int2"
dat.cor[[corname]]<-correct(interaction = TRUE)

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr8.pdf")
mdsCompPlot(mds.list = mdslist[c("pre","SeqPC1234int",corname)],fname = "MDS_Comp8.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC1234int2_all.pdf")
...
# cor9 spc12346int -------------
modVars<-c("GT","Time","GT*Time","seqPC1","seqPC2","seqPC3","seqPC4","seqPC6")
corname<-"SeqPC12346int"
dat.cor[[corname]]<-correct(interaction = TRUE)

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr9.pdf")
mdsCompPlot(mds.list = mdslist[c("pre","SeqPC1234int2",corname)],fname = "MDS_Comp9.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC12346int_all.pdf")
...
cormatrix(pclist = PCAdatlist,
          expPCs = corname,
          fname = "CorrPlot_Corr9.pdf")

# cor10 spc1234567int -------------
modVars<-c("GT","Time","GT*Time","seqPC1","seqPC2","seqPC3","seqPC4","seqPC5","seqPC6","seqPC7")
corname<-"SeqPC1234567int"
dat.cor[[corname]]<-correct(interaction = TRUE)

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr10.pdf")
mdsCompPlot(mds.list = mdslist[c("pre","SeqPC12346int",corname)],fname = "MDS_Comp10.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC1234567int_all.pdf")
...
cormatrix(pclist = PCAdatlist,
          expPCs = corname,
          fname = "CorrPlot_Corr10.pdf")



pheatmap(mat = t(picardgrp),width = 8,height = 5,
         clustering_method="average",
         scale = "row",
#          labels_col = target$GTtime,
         legend = T,filename = paste0(figdir,"picardhm.pdf"))


# dea------

datexprList<-dat.cor[c("SeqPC1234","SeqPC1234int","SeqPC1234int2","SeqPC12346int","SeqPC1234567int")]
...
dtdat$Correction<-factor(dtdat$Correction, levels=c("SeqPC1234","SeqPC1234int","SeqPC1234int2","SeqPC12346int","SeqPC1234567int"))
