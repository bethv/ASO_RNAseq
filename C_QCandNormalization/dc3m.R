...
# 
# mdsplot1v2(mdslist$pre,figdir,"MDS_pre0.pdf")
# mdsplotAll(mdslist$pre,figdir,"MDS_pre_all0.pdf")
...
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC23_all.pdf")
...
# cor8 spc12346 -------------
modVars<-c("GT","seqPC1","seqPC2","seqPC3","seqPC4","seqPC6")
corname<-"SeqPC12346"
dat.cor[[corname]]<-correct()
...
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC12346_all.pdf")
...
# cor9 spc123467 -------------
modVars<-c("GT","seqPC1","seqPC2","seqPC3","seqPC4","seqPC6","seqPC7")
corname<-"SeqPC123467"
dat.cor[[corname]]<-correct()

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr9.pdf")
mdsCompPlot(mds.list = mdslist[c("pre",corname)],fname = "MDS_Comp9.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC123467_all.pdf")
...
# cor10 spc1234567 -------------
modVars<-c("GT","seqPC1","seqPC2","seqPC3","seqPC4","seqPC5","seqPC6","seqPC7")
corname<-"SeqPC1234567"
dat.cor[[corname]]<-correct()

mdslist[[corname]]<-makemds.set(data = dat.cor[[corname]])
mdsplot1v2(mds.set = mdslist[[corname]],fname = "MDS_Corr10.pdf")
mdsCompPlot(mds.list = mdslist[c("pre",corname)],fname = "MDS_Comp10.pdf")
mdsplotAll(mds.set = mdslist[[corname]],fname = "MDS_SeqPC1234567_all.pdf")
...
datexprList<-dat.cor[c("SeqPC123","SeqPC1234","SeqPC12346","SeqPC123467","SeqPC1234567")]
GT<-factor(target$GT)
...
tt<-topTable(fitList$SeqPC1234567,coef = "Hem - WT",adjust.method = "BH",number = "inf")
saveRDS(tt, file = paste0(datdir,"tt_seqPC1234567.rds"))
write.csv(tt, file = paste0(datdir,"tt_seqPC1234567.csv"))
...
dim(eset.cor)
exprs(eset.cor)<-as.matrix(dat.cor$SeqPC1234567)
...
saveRDS(eset.cor,"dc3m_spc1234567eset.rds")
